...
class App {
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number = 1, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: 'https://picsum.photos/seed/hm1/800/600', text: 'Home Collection' },
      { image: 'https://picsum.photos/seed/hm2/800/600', text: 'Lab Reports' },
      { image: 'https://picsum.photos/seed/hm3/800/600', text: 'Doctor Consult' },
      { image: 'https://picsum.photos/seed/hm4/800/600', text: 'Health Records' },
      { image: 'https://picsum.photos/seed/hm5/800/600', text: 'NRI Care' },
      { image: 'https://picsum.photos/seed/hm6/800/600', text: 'Diagnostics' },
      { image: 'https://picsum.photos/seed/hm7/800/600', text: 'Pathology' },
      { image: 'https://picsum.photos/seed/hm8/800/600', text: 'Wellness' },
    ];
